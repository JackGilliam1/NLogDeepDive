...
{
    public class TypeCalculatorLogger : ILogger
    {
        private readonly Logger _logger;

        public TypeCalculatorLogger()
        {
            _logger = LogManager.GetLogger("TypeCalculator.TypeCalculatorLogger");
            Name = _logger.Name;
            Factory = _logger.Factory;
            IsDebugEnabled = true;
            IsErrorEnabled = true;
            IsFatalEnabled = true;
            IsInfoEnabled = true;
